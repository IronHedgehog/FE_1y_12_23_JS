...
const debounceLeading = document.querySelector(".output.leading");
...
document.addEventListener(
  "scroll",
  _.debounce(onScrollDebouncedLeading, 300, {
    trailing: false,
    leading: true,
  })
);

function onScrollDebouncedLeading(e) {
  counter.debounceLeading += 1;
  debounceLeading.textContent = counter.debounceLeading;
}
